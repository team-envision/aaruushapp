    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: Form(
            key: profileController.state.formkey,
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: CustomTextField(
                        ...
                        controller: profileController.state.nameController,
                      ),
                    ),
                  ),
                  Padding(
                    ...
                    child: SizedBox(
                      height: 55,
                      child: CustomTextField(
                        controller: profileController.state.phoneController,
                        label: 'Phone',
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      height: 55,
                      child: CustomTextField(
                        controller: profileController.state.emailController,
                        label: 'Email',
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: primaryButton(
                        text: "Save",
                        onTap: () {
                          if (profileController.state.formkey.currentState!.validate()) {
