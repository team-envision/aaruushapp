              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Aaruush Connect App",
                      style:
                          Get.theme.kSubTitleTextStyle.copyWith(fontSize: 25)),
                  sizeBox(8, 0),
                  GestureDetector(
                    onTap: () async {
                      ...
                      children: [
                        Text("Developed by Team Envision",
                            style: Get.theme.kVerySmallTextStyle.copyWith(
                                // decoration: TextDecoration.underline, decorationColor: Get.theme.colorPrimary,
                    ...
                    child: CustomBox(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          style:
                              Get.theme.kSmallTextStyle.copyWith(fontSize: 16),
                          textAlign: TextAlign.justify,
                        ),
                      ),
                    ),
